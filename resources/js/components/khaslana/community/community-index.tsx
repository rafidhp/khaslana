...
export default function CommunityIndex() {
    return (
        <UserLayout>
            <div className="flex flex-col items-center pt-28 max-md:pt-18 px-6 lg:px-[55px] w-full">
                <section className="community-header flex flex-col pt-8 pb-[40px] 2xl:px-17 items-center max-md:pb-5 gap-2">
